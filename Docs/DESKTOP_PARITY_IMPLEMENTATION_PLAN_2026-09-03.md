...
| PARITY-013 webhook | VERIFY | GitHub delivery/event/payload envelope、loopback POST `/webhook/github`、有界去重及跨重启 delivery state 已实现；8 个 LocalStateServer 测试通过；签名验证和 Agent/Job 触发待实现 |

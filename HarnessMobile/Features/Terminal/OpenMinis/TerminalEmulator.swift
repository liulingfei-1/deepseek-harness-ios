...
final class TerminalEmulator: ObservableObject {
    ...
    private func handleOSC(command: Int, payload: String) {
        ...
        case 2: // Set Window Title
            title = payload
        case 1337:
            // Minis uses this private OSC channel to ask its host UI to open
            // URLs. Harness Mobile intentionally keeps terminal output inert;
            // URLs remain tappable in the rendered transcript instead.
            break
        default:
            break
        }
